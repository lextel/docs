...
gv_vAlignTable['u25'] = 'center';gv_vAlignTable['u46'] = 'center';
u31.style.cursor = 'pointer';
$axure.eventManager.click('u31', function(e) {

if (true) {

	self.location.href=$axure.globalVariableProvider.getLinkUrl('所有商品（分类）.html');

}
});
gv_vAlignTable['u38'] = 'center';gv_vAlignTable['u23'] = 'top';gv_vAlignTable['u62'] = 'center';document.getElementById('u53_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('所有商品（添加到购物车）.html');
